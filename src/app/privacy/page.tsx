        ...
        <main className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="space-y-8 text-lg text-gray-700">
            ...
            <section className="space-y-4">
              <h3 className="text-2xl font-bold text-gray-900">Consent</h3>
            ...
            <section className="space-y-4">
              <h3 className="text-2xl font-bold text-gray-900">Google DoubleClick DART Cookie</h3>
              <p>
            ...
            <section className="space-y-4">
              <h3 className="text-2xl font-bold text-gray-900">GDPR Data Protection Rights</h3>
              <p>
