      ...
      <div className="min-h-screen bg-white">
        <main className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="space-y-8 text-lg text-gray-700">
            <p>
              Welcome to <span className="font-semibold">Castles</span>!
            </p>
  
            <p>
              These terms and conditions outline the rules and regulations for the use of{" "}
              <span className="font-semibold">Castles</span>, located at{" "}
              <span className="text-blue-600">&quot;Castles@gmail.com&quot;</span>.
            </p>
  
            <p>
              By accessing this website we assume you accept these terms and conditions. Do not continue to use{" "}
              <span className="font-semibold">Castles</span> if you do not agree to take all of the terms and conditions
              stated on this page.
            </p>
            ...
            <section className="space-y-4">
              ...
              <p>
                We employ the use of cookies. By accessing <span className="font-semibold">Castles</span>, you agreed to
                use cookies in agreement with the privacy policy of <span className="font-semibold">Castles</span>.
              </p>
              <p>
            ...
            <section className="space-y-4">
              <h3 className="text-2xl font-bold text-gray-900">License</h3>
              <p>
                Unless otherwise stated, <span className="font-semibold">Castles</span> and/or its licensors own the
                intellectual property rights for all material on <span className="font-semibold">Castles</span>. All
                intellectual property rights are reserved. You may access this from{" "}
                <span className="font-semibold">Castles</span> for your own personal use subjected to restrictions set
                in these terms and conditions.
              </p>
              <p className="font-semibold">You must not:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Republish material from Castles</li>
                <li>Sell, rent or sub-license material from Castles</li>
                <li>Reproduce, duplicate or copy material from Castles</li>
                <li>Redistribute content from Castles</li>
              </ul>
            </section>
  
            <section className="space-y-4">
              <h3 className="text-2xl font-bold text-gray-900">Hyperlinking to our Content</h3>
            ...
            <section className="space-y-4">
              <h3 className="text-2xl font-bold text-gray-900">iFrames</h3>
              <p>
            ...
            <section className="space-y-4">
              <h3 className="text-2xl font-bold text-gray-900">Content Liability</h3>
              <p>
            ...
            <section className="space-y-4">
              <h3 className="text-2xl font-bold text-gray-900">Your Privacy</h3>
              <p>Please read our Privacy Policy.</p>
            </section>
  
            <section className="space-y-4">
              <h3 className="text-2xl font-bold text-gray-900">Reservation of Rights</h3>
              <p>
