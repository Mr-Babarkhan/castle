    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-12">
          ...
          <h5 className="text-2xl font-bold ">Easy way to download videos:</h5>
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-800 leading-relaxed -mt-8">
              <a href="#" className="text-blue-600 hover:underline">
                Snaptube
          ...
          <h5 className="text-2xl font-bold ">Conversion of Videos Into Mp3:</h5>
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-800 leading-relaxed -mt-8">
              <a href="#" className="text-blue-600 hover:underline">
                Snaptube
          ...
          <h5 className="text-2xl font-bold ">Various Websites Supported:</h5>
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-800 leading-relaxed -mt-8">
              <a href="#" className="text-blue-600 hover:underline">
                Snaptube
          ...
          <h5 className="text-2xl font-bold ">Facility of Dark Mode:</h5>
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-800 leading-relaxed -mt-8">
              <a href="#" className="text-blue-600 hover:underline">
                Snaptube
          ...
          <h5 className="text-2xl font-bold ">Resume Interrupted Downloads:</h5>
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-800 leading-relaxed -mt-8">
              <a href="#" className="text-blue-600 hover:underline">
                Snaptube
          ...
          <h5 className="text-2xl font-bold ">Make Music Library:</h5>
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-800 leading-relaxed -mt-8">
              <a href="#" className="text-blue-600 hover:underline">
                Snaptube
          ...
          <h5 className="text-2xl font-bold ">Free From Frustrating Ads:</h5>
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-800 leading-relaxed -mt-8">
              <a href="#" className="text-blue-600 hover:underline">
                Snaptube
          ...
          <h5 className="text-2xl font-bold ">Quick Downloading Speed:</h5>
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-800 leading-relaxed -mt-8">
              <a href="#" className="text-blue-600 hover:underline">
                Snaptube
        ...
        <h5 className="text-2xl font-bold ">User-Friendly Interface:</h5>
            <div className="prose prose-lg max-w-none">
                <p className="text-gray-800 leading-relaxed -mt-8">
                <a href="#" className="text-blue-600 hover:underline">
                    Snaptube
            ...
            <h5 className="text-2xl font-bold ">Free Application:</h5>
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-800 leading-relaxed -mt-8">
              <a href="#" className="text-blue-600 hover:underline">
                Snaptube
          ...
          <h5 className="text-2xl font-bold ">Safe and Secure Application</h5>
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-800 leading-relaxed -mt-8">
              <a href="#" className="text-blue-600 hover:underline">
                Snaptube
          ...
          <div className="prose prose-lg max-w-none">
           ...
           <li>Easy way to download videos</li>
              <li>Conversion of Videos Into Mp3</li>
                <li>Various Websites Supported</li>
                <li>Facility of Dark Mode</li>  
                <li>Resume Interrupted Downloads</li>
                <li>Make Music Library</li>
                <li>Free From Frustrating Ads</li>
                <li>Quick Downloading Speed</li>
                <li>User-Friendly Interface</li>
                <li>Free Application</li>
                <li>Safe and Secure Application</li>

          </div>
          <h5 className="text-2xl font-bold ">Final Words</h5>
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-800 leading-relaxed -mt-8">
              <a href="#" className="text-blue-600 hover:underline">
                Snaptube
