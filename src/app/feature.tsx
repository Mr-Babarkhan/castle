...
export default function FeaturesPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-6xl">
      <h1 className="text-4xl md:text-5xl font-bold text-center mb-8">Castle Apk</h1>
      ...
      <p className="text-gray-600 text-center text-lg md:text-xl leading-relaxed mb-16 max-w-4xl mx-auto">
        ...
        then you are at the right place and in this article, we will explain an outstanding application named Castle.
